...
public class PortalController {
    ...
    @PostMapping(PortalConstant.CREATE_PORTAL)
    ResponseDTO createPortalInfo(@RequestBody PortalRequestDto portalRequestDto) {
        return portalService.createPortalInfo(portalRequestDto);
    }
}
